...
export class StudentMySuffixService {
    ...
    create(student: StudentMySuffix): Observable<StudentMySuffix> {
    ...
    update(student: StudentMySuffix): Observable<StudentMySuffix> {
        const copy = this.convert(student);
    ...
    find(id: number): Observable<StudentMySuffix> {
